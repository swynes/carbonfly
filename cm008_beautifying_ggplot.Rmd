...
#Try: theme_bw , theme_void , theme_bw
```
...
p1 + scale_x_log10(breaks=c((1:10)*1000,
                            (1:10)*10000))
#to get rid of overlapping labels either choose fewer breaks or rotate the labels
...
#CHanged the labels of the legend from "Africa" to "Af" etc.
```
