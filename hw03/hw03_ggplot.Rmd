...
gapminder %>%
  ...
  arrange(bust) %>% 
    knitr::kable()
```
Now the largest single decrease is still in Iraw, but the largest increase is now in Korea. Unfortunately the table is long and is not displaying the year and I'm not sure how to fix that (for instance I can't get the head() function to work in place of summarize).
